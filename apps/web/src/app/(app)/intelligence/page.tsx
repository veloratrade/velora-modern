  ...
  return (
    <div>
      <div className="page-head">
        <div>
          <h1 className="page-title">{isFa ? "هوش معامله" : "Intelligence"}</h1>
          <p className="page-sub">Journal chat & AI insights — GAP-AI-BE (simulated in landing, real provider not wired)</p>
        </div>
      ...
      <div className="card">
        ...
        <div className="flex-gap-8 mt-12">
          <span className="badge badge-disconnected">OWNER DECISION: R8 public/protected for /intelligence</span>
