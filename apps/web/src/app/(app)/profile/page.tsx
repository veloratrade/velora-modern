  ...
  return (
    <div>
      <div className="page-head">
        <div>
          <h1 className="page-title">{isFa ? "پروفایل" : "Profile"}</h1>
          <p className="page-sub">User profile & preferences — PATCH /auth/me/preferences (locale, ai_consent) exists; full profile UI shell</p>
        </div>
      ...
      <div className="card">
        ...
        <div className="flex-gap-8 mt-12">
          <span className="badge badge-disconnected">OWNER DECISION: R8 public/protected for /profile</span>
