  ...
  return (
    <div>
      <div className="page-head">
        <div>
          <h1 className="page-title">{isFa ? "بازارها" : "Markets"}</h1>
          <p className="page-sub">Live market overview — TradingView-style (Legacy protected, Modern R8 decision pending)</p>
        </div>
      ...
      <div className="card">
        ...
        <div className="flex-gap-8 mt-12">
          <span className="badge badge-disconnected">OWNER DECISION: R8 public/protected for /markets</span>
