  ...
  return (
    <div>
      <div className="page-head">
        <div>
          <h1 className="page-title">{isFa ? "مدیریت" : "Admin"}</h1>
          <p className="page-sub">Admin — RBAC matrix & audit log (backend COMPLETED, UI PLANNED)</p>
        </div>
      ...
      <div className="card">
        ...
        <div className="flex-gap-8 mt-12">
          <span className="badge badge-disconnected">OWNER DECISION: R8 public/protected for /admin</span>
