  ...
  return (
    <div>
      <div className="page-head">
        <div>
          <h1 className="page-title">{isFa ? "پشتیبانی" : "Support"}</h1>
          <p className="page-sub">Support tickets — GAP-SUP (no Modern API yet)</p>
        </div>
      ...
      <div className="card">
        ...
        <div className="flex-gap-8 mt-12">
          <span className="badge badge-disconnected">OWNER DECISION: R8 public/protected for /support</span>
