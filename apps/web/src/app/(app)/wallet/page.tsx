  ...
  return (
    <div>
      <div className="page-head">
        <div>
          <h1 className="page-title">{isFa ? "کیف پول" : "Wallet"}</h1>
          <p className="page-sub">Wallet & subscriptions — Stripe checkout /billing/* (provider-gated)</p>
        </div>
      ...
      <div className="card">
        ...
        <div className="flex-gap-8 mt-12">
          <span className="badge badge-disconnected">OWNER DECISION: R8 public/protected for /wallet</span>
